 ...
 *
 * FILE NAME   : hotkeys-sidebar.ahk
 *               
 * DESCRIPTION : AutHotkey script file for functions inside the Side Bar area
 *               of USU Valuemation ITSM tool.
 *               
...
; OPEN TICKET
;
; Opens an existing ticket by clicking the 'Open ticket' button in the Sidebar
; under Actions.
