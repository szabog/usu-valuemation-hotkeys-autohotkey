 ...
 *
 * FILE NAME   : hotkeys-ticket.ahk
 *               
 * DESCRIPTION : AutHotkey script file for functions inside the Ticket area
...
; ADD NOTE
;
; Opens the New: Ticket Description window by clicking the
